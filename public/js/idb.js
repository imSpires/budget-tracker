...
request.onupgradeneeded = function(event) {
    ...
    // create an object store called `transaction`, set it to have an auto incrementing primary key of sorts 
...
// This function will be exuctued if we reconnect to the internet
